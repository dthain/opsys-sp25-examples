...
WARNING: This solution is incorrect and results in a deadlock.
Run the program enough times until you observe that it does indeed deadlock.
(You might need to reduce the sleeptime to run faster.)
Can you fix it?
*/
